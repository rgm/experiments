...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_28798 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_28798(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_28800 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_28800(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_28801 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_28801(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_28803 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_28803(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_28804 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_28804(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_28809 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_28809(reader);
}
});
...
var G__28845 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__28846 = s.append(c);
c = G__28845;
s = G__28846;
continue;
}
