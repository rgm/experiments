...
var G__35742 = o;
goog.object.set(G__35742,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__35760__delegate = function (args){
...
while (G__35761__i < G__35761__a.length) {G__35761__a[G__35761__i] = arguments[G__35761__i + 0]; ++G__35761__i;}
  args = new cljs.core.IndexedSeq(G__35761__a,0,null);
} 
return G__35760__delegate.call(this,args);};
G__35760.cljs$lang$maxFixedArity = 0;
G__35760.cljs$lang$applyTo = (function (arglist__35762){
var args = cljs.core.seq(arglist__35762);
return G__35760__delegate(args);
});
...
var G__35743 = o;
goog.object.set(G__35743,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__35778__i < G__35778__a.length) {G__35778__a[G__35778__i] = arguments[G__35778__i + 0]; ++G__35778__i;}
  args = new cljs.core.IndexedSeq(G__35778__a,0,null);
} 
...
var args = cljs.core.seq(arglist__35779);
...
var G__35744 = props;
var G__35744__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35744,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__35744);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35744__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__35745 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35745,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__35745;
}
})(),id_class);
...
var G__35746 = (cljs.core.count(argv) - first_child);
switch (G__35746) {
case (0):
...
var vec__35747 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35747,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35747,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35747,(2),null);
...
var temp__5739__auto___35797 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___35797 == null)){
} else {
var key_35799 = temp__5739__auto___35797;
(jsprops.key = key_35799);
}
...
var temp__5739__auto___35806 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___35806 == null)){
} else {
var key_35807 = temp__5739__auto___35806;
(jsprops.key = key_35807);
}
...
var temp__5739__auto___35808 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___35808 == null)){
} else {
var key_35812 = temp__5739__auto___35808;
(jsprops.key = key_35812);
}
...
var temp__5739__auto___35818 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___35818 == null)){
} else {
var key_35822 = temp__5739__auto___35818;
(jsprops.key = key_35822);
}
...
var temp__5739__auto___35823 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___35823 == null)){
} else {
var key_35824 = temp__5739__auto___35823;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35750_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__35750_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__35751 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35751,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35751,(1),null);
...
break;
default:
var G__35829 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__35830 = compiler;
v = G__35829;
compiler = G__35830;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template35757 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template35757 = (function (opts,id,fn_to_element,meta35758){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template35757.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_35759,meta35758__$1){
var self__ = this;
var _35759__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template35757(self__.opts,self__.id,self__.fn_to_element,meta35758__$1));
}));

(reagent.impl.template.t_reagent$impl$template35757.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_35759){
var self__ = this;
var _35759__$1 = this;
return self__.meta35758;
}));

(reagent.impl.template.t_reagent$impl$template35757.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template35757.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template35757.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template35757.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template35757.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta35758","meta35758",510197546,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template35757.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template35757.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template35757");

(reagent.impl.template.t_reagent$impl$template35757.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template35757");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template35757.
 */
reagent.impl.template.__GT_t_reagent$impl$template35757 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template35757(opts__$1,id__$1,fn_to_element__$1,meta35758){
return (new reagent.impl.template.t_reagent$impl$template35757(opts__$1,id__$1,fn_to_element__$1,meta35758));
});

}

return (new reagent.impl.template.t_reagent$impl$template35757(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
