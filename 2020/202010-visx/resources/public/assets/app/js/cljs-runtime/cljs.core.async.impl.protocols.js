...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28802 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28802(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28805 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28805(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28810 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28810(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28814 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28814(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28815 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_28815(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28816 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_28816(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_28819 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_28819(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28820 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28820(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28824 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28824(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28825 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28825(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28831 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28831(b);
}
});
