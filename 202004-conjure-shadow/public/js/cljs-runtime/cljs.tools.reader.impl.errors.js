...
var len__4730__auto___25465 = arguments.length;
var i__4731__auto___25466 = (0);
while(true){
if((i__4731__auto___25466 < len__4730__auto___25465)){
args__4736__auto__.push((arguments[i__4731__auto___25466]));

var G__25467 = (i__4731__auto___25466 + (1));
i__4731__auto___25466 = G__25467;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_ex.cljs$lang$applyTo = (function (seq25371){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25372,G__25373,seq25371__$2);
}));
...
var G__25471 = (i__4731__auto___25470 + (1));
i__4731__auto___25470 = G__25471;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.reader_error.cljs$lang$applyTo = (function (seq25381){
var G__25382 = cljs.core.first(seq25381);
var seq25381__$1 = cljs.core.next(seq25381);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25382,seq25381__$1);
}));
...
var args__4736__auto__ = [];
var len__4730__auto___25477 = arguments.length;
var i__4731__auto___25478 = (0);
while(true){
if((i__4731__auto___25478 < len__4730__auto___25477)){
args__4736__auto__.push((arguments[i__4731__auto___25478]));

var G__25479 = (i__4731__auto___25478 + (1));
i__4731__auto___25478 = G__25479;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.illegal_arg_error.cljs$lang$applyTo = (function (seq25389){
var G__25390 = cljs.core.first(seq25389);
var seq25389__$1 = cljs.core.next(seq25389);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25390,seq25389__$1);
}));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.eof_error.cljs$lang$applyTo = (function (seq25401){
var G__25402 = cljs.core.first(seq25401);
var seq25401__$1 = cljs.core.next(seq25401);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25402,seq25401__$1);
}));
...
var args__4736__auto__ = [];
var len__4730__auto___25492 = arguments.length;
var i__4731__auto___25493 = (0);
while(true){
if((i__4731__auto___25493 < len__4730__auto___25492)){
args__4736__auto__.push((arguments[i__4731__auto___25493]));

var G__25494 = (i__4731__auto___25493 + (1));
i__4731__auto___25493 = G__25494;
continue;
} else {
}
break;
...
var init = (function (){var G__25422 = kind;
var G__25422__$1 = (((G__25422 instanceof cljs.core.Keyword))?G__25422.fqn:null);
switch (G__25422__$1) {
case "regex":
return "#\"";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25422__$1)].join('')));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_eof_reading.cljs$lang$applyTo = (function (seq25419){
...
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25420,G__25421,seq25419__$2);
}));
...
var iter__4523__auto__ = (function cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__25452(s__25453){
return (new cljs.core.LazySeq(null,(function (){
var s__25453__$1 = s__25453;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__25453__$1);
if(temp__5735__auto__){
var s__25453__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__25453__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__25453__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__25455 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__25454 = (0);
while(true){
if((i__25454 < size__4522__auto__)){
var vec__25456 = cljs.core._nth(c__4521__auto__,i__25454);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25456,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25456,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__25455,id);

var G__25510 = (i__25454 + (1));
i__25454 = G__25510;
continue;
} else {
var G__25511 = (i__25454 + (1));
i__25454 = G__25511;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__25455),cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__25452(cljs.core.chunk_rest(s__25453__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__25455),null);
}
} else {
var vec__25459 = cljs.core.first(s__25453__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25459,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25459,(1),null);
if((freq > (1))){
return cljs.core.cons(id,cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__25452(cljs.core.rest(s__25453__$2)));
} else {
var G__25517 = cljs.core.rest(s__25453__$2);
s__25453__$1 = G__25517;
continue;
}
}
} else {
